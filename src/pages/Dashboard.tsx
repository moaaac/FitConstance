        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-emerald-100">Bem-vindo ao seu painel de saúde</p>
            </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-emerald-600">{userProfile.imc}</p>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">{userProfile.pesoAtual}kg</p>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg font-bold text-purple-600">{userProfile.experiencia}</p>
                  <Badge variant="outline" className="text-xs mt-1">
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-orange-600">{Math.round(progressoPeso)}%</p>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="p-3 bg-red-50 rounded-lg">
                  <h4 className="font-medium text-sm text-red-800">Treino do Dia</h4>
                  <p className="text-xs text-red-600 mt-1">Treino de Peito e Tríceps</p>
                </div>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="p-3 bg-green-50 rounded-lg">
                  <h4 className="font-medium text-sm text-green-800">Plano Nutricional</h4>
                  <p className="text-xs text-green-600 mt-1">Foco em ganho de massa</p>
                </div>
                <div className="p-3 bg-gray-50 rounded-lg">
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="p-3 bg-blue-50 rounded-lg">
                  <h4 className="font-medium text-sm text-blue-800">Alongamentos</h4>
                  <p className="text-xs text-blue-600 mt-1">Rotina pré e pós treino</p>
                </div>
                <div className="p-3 bg-gray-50 rounded-lg">
